...
export function FAQ() {
    return (
        <section className=" w-full py-10 md:py-24 bg-background bg-black text-white">
            <div className=" container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                ...
                <div className=" mb-12">
                    ...
                    <Button variant="link" className="mt-2 text-primary bg-[#FF8904] text-white rounded-full px-8 py-2">
                        See All FAQs
                    </Button>
                </div>
                            ...
                            <Accordion type="single" collapsible className="w-full gap-6 ">
                                {faqs.map((faq, index) => (
                                    <AccordionItem
                                        key={index}
                                        value={`item-${index}`}
                                        className=" bg-[#202020] rounded-lg px-2"
                                    >
                                        <AccordionTrigger className="text-left font-medium text-base md:text-lg py-4 hover:no-underline">
                                            {faq.question}
                                        </AccordionTrigger>
