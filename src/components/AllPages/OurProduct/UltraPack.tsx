...
export default function UltraPack() {
    ...
    return (
        <div className="containers mt-3 md:mt-4  lg:pb-20 pb-8 md:pb-10 overflow-hidden">
            {/* GRID */}
            <div className="grid grid-cols-1 gap-9 md:gap-14 lg:grid-cols-5 lg:gap-[35px] xl:gap-25 items-center">

                {/* LEFT CARD */}
                <div className="relative mx-auto w-full max-w-full lg:col-span-3" data-aos="zoom-in" data-aos-duration="1500">
                    ...
                    <div className="relative px-2 sm:px-4 md:px-6">
                        <div className="relative z-10 mt-2 md:mt-6 flex min-h-[400px] w-full items-start justify-start rounded-xl md:rounded-2xl bg-white px-4 pt-[40px] md:pt-[67px] pb-8 shadow-lg sm:min-h-[470px] sm:px-6 md:min-h-[500px] md:px-8 lg:px-4 xl:px-8">
                            ...
                            <div>
                                <div className="max-w-[58%] sm:max-w-[56%] max-[363px]:w-[132px] max-[330px]:max-w-[120px] space-y-3 text-sm text-[#4A5565] sm:text-base">
                                    ...
                                    <ul className="mt-5 space-y-3 text-sm text-[#4A5565] sm:text-base">
                                        {t.products?.ultra?.insidePacks?.items?.map(
                            ...
                            <div
                                ...
                                className="group perspective absolute mt-1.5  -right-[5px] sm:right-[30px] md:right-[20px] lg:right-[-10px] xl:right-[1px] 2xl:right-[15px] flex cursor-pointer items-center justify-center rounded-xl"
                            >
                                <div
                        ...
                        <div className="relative z-10 mt-2 md:mt-6 flex min-h-[400px] w-full items-center justify-start rounded-xl md:rounded-2xl bg-white px-4 py-8 shadow-lg sm:min-h-[470px] sm:px-6 md:min-h-[500px] md:px-8 lg:px-4 xl:px-8">
                            ...
                            <div>
                                ...
                                <li className=" block md:hidden">
                                    <p className="flex gap-2 text-sm mt-7   text-[#4A5565] min-[467px]:w-[250px]  sm:text-base">
                                        <BsStars className="h-6 w-9" />
                                        {t.products?.ultra?.insidePacks?.specialNote}
                                    </p>
                                </li>
                            ...
                            <div
                                onClick={() => setIsFlipped(!isFlipped)}
                                className="group perspective absolute top-1/3 md:top-1/2 mt-8 sm:mt-12 md:mt-2 xl:-mt-0.5  2xl:-mt-3.5 -right-[5px] sm:right-[30px] md:right-[20px] lg:right-[-45px] xl:right-[10px] 2xl:right-[15px] flex -translate-y-1/2 cursor-pointer items-center justify-center rounded-xl "
                            >
                                <div
                ...
                {/* RIGHT TEXT */}
                <div className="order-[-1] lg:order-none lg:col-span-2 flex flex-col justify-start lg:justify-center  lg:px-0"
