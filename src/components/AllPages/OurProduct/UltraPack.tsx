                        ...
                        <div className="relative z-10 mt-2 md:mt-6 flex min-h-[400px] w-full items-center justify-start rounded-2xl bg-white px-4 py-8 shadow-lg sm:min-h-[470px] sm:px-6 md:min-h-[500px] md:px-8">
                            ...
                            <div>
                                <div className="max-w-[58%] sm:max-w-[56%]">
                                    <h2 className="flex items-center md:mt-4.5 mt-6 gap-2 text-lg font-semibold sm:text-2xl md:text-3xl">
                            ...
                            <div
                                ...
                                className="group perspective absolute top-1/3 md:top-1/2 mt-9.5 md:-mt-3 right-[2px] sm:right-[30px] md:right-[20px] lg:right-[-45px] xl:right-[10px] 2xl:right-[15px] flex -translate-y-1/2 cursor-pointer items-center justify-center rounded-xl "
                            >
                                <div
