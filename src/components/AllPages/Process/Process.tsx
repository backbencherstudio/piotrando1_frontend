    ...
    const steps = [
        {
            number: "Step 1",
            title: "SOURCING",
            description: "We acquire authenbc cards trom trusted partners, resellers. tournaments. and global Suo liers",
        ...
        },
        {
            ...
            description: "Each card is inspected Wvice  before acquisition and before packaging.",
        ...
        },
        {
            number: "Step 4",
            title: "PACK ASSEMBLY",
            description: "We design and assemble each pack in-house with carefully balanced card ratios_",
        ...
        <main className=" bg-[#0E1115] py-10 lg:py-20 px-4">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-16" data-aos="zoom-out-up" data-aos-duration="1500">
                    ...
                    <h1 className="text-3xl md:text-4xl lg:text-5xl uppercase font-normal pt-6 pb-2 font-secondary text-[#FFF] bg-clip-text  mb-4">
                            ...
                            <div className="bg-[#171A21] rounded-2xl p-6">
                                ...
                                <div className="flex items-center gap-2  mb-4">
                                    ...
                                    <div>
                                        ...
                                        <h3 className="text-2xl font-normal text-white mb-3 leading-120% font-secondary">
                                            {step.title}
                                        </h3>
                                    </div>
